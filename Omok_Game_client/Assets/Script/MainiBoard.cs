...
public class MainBoard : MonoBehaviour
{
    ...
    public bool TryCreateStone(Vector3 worldPos)
    {
        ...
        // 7) 돌 생성 & 보드 상태 갱신
        var prefab = GameManager.instance.isBlackTurn ? BlackStonePrefab : WhiteStonePrefab;
        Instantiate(prefab, grid.GetCellCenterWorld(cell), Quaternion.identity);
        board[cell.x, cell.y] = GameManager.instance.isBlackTurn ? Stone.Black : Stone.White;
